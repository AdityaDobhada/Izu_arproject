...
#     cv2.putText(image, text, position, cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 255), 2)
...
# draw_text(frame, f'Suit Length: {lengths}', (10, 30))
# draw_text(frame, f'Arm Length: {arms}', (10, 60))
# draw_text(frame, f'Chest: {chests}', (10, 90))
# draw_text(frame, f'Shoulder Length: {shoulder}', (10, 120))
# draw_text(frame, f'Pant Length: {paint_lenght}', (10, 150))

# draw_text(frame, f'Upper Body Waist: {circume_ference}', (10, 180))
# draw_text(frame, f'Chest Circumference: {cht}', (10, 210))
# draw_text(frame, f'Heap Circumference: {heap}', (10, 240))
# draw_text(frame, f'Thigh Circumference: {thigh}', (10, 270))
# 
...
draw_formatted_text(frame, f'Suit Length: {lengths}', (10, 30), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Arm Length: {arms}', (10, 60), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Chest: {chests}', (10, 90), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Shoulder Length: {shoulder}', (10, 120), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Pant Length: {paint_lenght}', (10, 150), font_scale=3, font_color=(0, 255, 0), font_thickness=1)

# ... (your existing code) ...

# Display the values of the circular measurements on the image with custom formatting
draw_formatted_text(frame, f'Upper Body Waist: {circume_ference}', (10, 180), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Chest Circumference: {cht}', (10, 210), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Heap Circumference: {heap}', (10, 240), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
draw_formatted_text(frame, f'Thigh Circumference: {thigh}', (10, 270), font_scale=3, font_color=(0, 255, 0), font_thickness=1)
